...
class CustomArgument final
{
    union
    {
        ...
        int m_int;
        unsigned int m_uint;
        long long m_longLongInt;
        unsigned long long m_uLongLongInt;
        float m_float;
        double m_double;
        void *m_ptr;
    };
...
public:
    ...
    explicit CustomArgument(Element *f_element);
    ...
    inline Element* GetElement() const { return reinterpret_cast<Element*>(m_ptr); };
