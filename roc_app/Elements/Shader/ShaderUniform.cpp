...
unsigned int ROC::ShaderUniform::GetType() const
{
    return m_type;
}
bool ROC::ShaderUniform::IsSampler2D() const
{
    return ((m_type == SUT_Sampler) || (m_type == SUT_ShadowSampler));
}
bool ROC::ShaderUniform::IsSamplerCube() const
{
    return (m_type == SUT_CubeSampler);
}
...
bool ROC::ShaderUniform::IsActive() const
{
    return m_active;
}
