...
{
    if(std::memcmp(&f_pos, &m_listenerPosition, sizeof(glm::vec3)))
    {
...
{
    if(std::memcmp(&f_dir, &m_listenerDirection, sizeof(glm::vec3)))
    {
...
{
    if(std::memcmp(&f_up, &m_listenerUp, sizeof(glm::vec3)))
    {
