...
public:
    ...
    inline bool IsColored() const { return (m_type >= RENDERTARGET_TYPE_RGB && m_type <= RENDERTARGET_TYPE_RGBF); }
    inline bool IsTransparent() const { return (m_type == RENDERTARGET_TYPE_RGBA); }
