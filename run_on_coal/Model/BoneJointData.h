...
protected:
    ...
    BoneJointData();
    ~BoneJointData();
    void AddPart(unsigned int f_bone, unsigned char f_type, glm::vec3 &f_size, glm::vec3 &f_pos, glm::quat &f_rot, float f_mass, glm::vec3 &f_lAL, glm::vec3 &f_uAL, glm::vec3 &f_aStiffness, glm::vec3 &f_lLL, glm::vec3 &f_uLL, glm::vec3 &f_lStiffness);
